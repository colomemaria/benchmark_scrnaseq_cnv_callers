...
dataset_groundtruth<-setNames(c("WGS_samelab",#"WGS_samelab","WGS_samelab","WGS_samelab","WGS_samelab",
                                ...
                                "WGS_otherlab","WGS_otherlab","WGS_otherlab","WES_samelab","WES_samelab","WES_samelab"),
                              dataset_names)
...
```{r}
assess_feature<-function(plot_char,feature_name,xlab_text="Correlation"){
  #Evaluate correlation
  g<-ggplot(plot_char,aes(x=value,y=.data[[feature_name]],color=dataset))+
    geom_point()+ geom_smooth(method='lm',color="black",se=FALSE)+
    facet_wrap(~method)+xlab(xlab_text)
  print(g)
  
  corr<-plot_char%>%
    group_by(method)%>%
    summarize(cor=cor(value,.data[[feature_name]]),
              cor_pval=cor.test(value,.data[[feature_name]])$p.value)%>%
    as.data.frame()
  
  corr$p_adjust<-p.adjust(corr$cor_pval,method="BH")
  print(kable(corr))
  
  corr$type<-feature_name
...
corr<-assess_feature(plot_char,"num_cancer_cells",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"num_cancer_cells",xlab_text="Maximal F1 score")
...
Remark - this part is not run, as the number of reference cells is the same for many datasets

```{r,fig.width=12,eval=FALSE}

#Evaluate the correlation
corr<-assess_feature(plot_char,"num_ref_cells",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"num_ref_cells",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
```
...
#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_umi_cancer",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_umi_cancer",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
Again not evaluated - same as with the number of reference cells before

```{r,fig.width=12, eval=FALSE}

#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_umi_ref",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_umi_ref",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
Associated with the mean UMI in the reference cells (so also skipped)

```{r,fig.width=12, eval=FALSE}

#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_umi_total",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_umi_total",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_coef_var",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_coef_var",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_drop_cell",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_drop_cell",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Evaluate the correlation
corr<-assess_feature(plot_char,"mean_nonZeroGenes_cell",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"mean_nonZeroGenes_cell",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Evaluate the correlation
corr<-assess_feature(plot_char,"total_cancer_umi",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Evaluate F1 score
corr<-assess_feature(plot_char_f1,"total_cancer_umi",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
print("Correlation between fraction gained and fraction CNVs total")
print(cor(bin_counts$fraction_gain,bin_counts$fraction_cnvs))
...
corr<-assess_feature(plot_bins,"fraction_gain",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_bins_f1,"fraction_gain",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_bins,"fraction_loss",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_bins_f1,"fraction_loss",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_bins,"fraction_cnvs",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_bins_f1,"fraction_cnvs",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_bins,"num_coverage",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_bins_f1,"num_coverage",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_bins_wgs,"num_breakpoints",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_bins_f1_wgs,"num_breakpoints",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_snp,"numbat_cells_wsnp",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_snp_f1,"numbat_cells_wsnp",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_snp,"numbat_nsnps",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_snp_f1,"numbat_nsnps",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
#Compare results using correlation 
corr<-assess_feature(plot_snp,"casper_nsnps",xlab_text="Correlation")
corr_feature_pearson<-rbind(corr_feature_pearson,corr)

#Compare results using F1 score 
corr<-assess_feature(plot_snp_f1,"casper_nsnps",xlab_text="Maximal F1 score")
corr_feature_f1<-rbind(corr_feature_f1,corr)
...
write.table(corr_feature_pearson,"results/correlation_datafeatures_pearson.tsv")
write.table(corr_feature_f1,"results/correlation_datafeatures_maxf1score.tsv")

```

Check also the p-values

=> the issue: the sample size is small and then we do so many tests ... 

```{r}

#P-value categories
corr_feature_pearson$fdr<-p.adjust(corr_feature_pearson$cor_pval,method="BH")

ggplot(corr_feature_pearson,aes(x=method,y=type,fill=cor_pval>0.1))+
  geom_tile()+
  xlab("Method")+ylab("Dataset characteristics")+
  ggtitle("Correlation raw p-values between characterstics and correlation")+
  #scale_fill_gradient2(high="red",mid="white",low="blue")+
  geom_text(aes(label=round(cor_pval,2)),
                #color=ifelse(abs(cor)>0.6,'white','black')),
            size=2.8)+
  #scale_color_manual(values=c("black","white"))+
  theme(legend.position="none",
...
#P-value categories
corr_feature_f1$fdr<-p.adjust(corr_feature_f1$cor_pval,method="BH")

ggplot(corr_feature_f1,aes(x=method,y=type,fill=cor_pval>0.1))+
  geom_tile()+
  xlab("Method")+ylab("Dataset characteristics")+
  ggtitle("Correlation raw p-values between characterstics and correlation")+
  #scale_fill_gradient2(high="red",mid="white",low="blue")+
...
Check the total correlation values:

```{r}

cor_summary<-corr_feature_f1%>%
  group_by(type)%>%
  summarize(min=min(abs(cor)),max=max(abs(cor)),
            mean=mean(abs(cor)),median=median(abs(cor)))

cor_summary[order(cor_summary$mean,decreasing=TRUE),]
