...
/store24/project24/ladcol_005/tools/cellranger-7.0.0/bin/cellranger count \
    ...
    --fastqs=/work/project/ladcol_010/benchmark_scrna_cnv_caller/data/input_HGC27 \
    --sample=SRR10805145 --localcores 4 --localmem 32 --id=HGC27_hg38_mapped
