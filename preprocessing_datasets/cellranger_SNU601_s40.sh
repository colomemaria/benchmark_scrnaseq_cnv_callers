...
/work/project/ladcol_005/tools/cellranger-7.0.0/bin/cellranger count \
    ...
    --fastqs=/work/project/ladcol_010/benchmark_scrna_cnv_caller/data/input_SNU601_sample40 \
    --sample=SRR10805153_sample40 --localcores 4 --localmem 32 --id=SNU601_sample40_hg38_mapped